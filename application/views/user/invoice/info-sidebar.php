	...
	<div class="col-12 list-info-invoice box-camp mb-4">
		<div class="row p-2">
			...
			<div class="col-12 text-center mb-3">					
				...
				<div class="mt-3">
					<button class="btn btn-primary" onclick="window.location='<?php echo site_url();?>/manual-payment'">
				...
				<button class="btn btn-success mt-2" 
					onclick="window.open('<?php echo site_url();?>/action/download-pdf-invoice/<?php echo $invoice['id'];?>')">
				...
				<?php if(
					...
					<button class="btn btn-danger mt-2" 
						onclick="cancelOrder('<?php echo $invoice['id'];?>')">
