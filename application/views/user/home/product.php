<div class="row p-3">
      ...
      <div class="box-camp d-flex flex-column justify-content-between border-radius-20" 
        ...
        <div class="card-header no-border bg-none text-center pos-relative" 
          style="height:50%">      
            ...
            ?>
              <div style="height:25px;width:25px;border-radius:50%;background:violet;position:absolute;bottom:20px;right:20px;padding-top:1px;" class="box-campc cursor-pointer"
  ...
  ?>
	...
	<div class="col-12 text-center mt-4 mb-4">
     ...
     onclick="window.location='<?php echo site_url();?>/product'">Lihat Semua Product</button>
	</div>
</div>