  			...
  			<div class="card shadow mb-4">      					
		    	<div class="card-body text-center">
		    		...
		    		<button class="btn btn-primary"
		    			onclick="window.location='<?php echo site_url();?>/admin/cronjob/action/backing-stuff';this.disabled = true">
		    			Jalanakan
		    		</button>
		    		<hr>
  		...
  		<div class="col-4">
  			<div class="card shadow mb-4">      					
		    	<div class="card-body text-center">
		    		...
		    		<hr/>
		    		<button class="btn btn-primary"
		    			onclick="window.location='<?php echo site_url();?>/admin/cronjob/action/expired-invoice';this.disabled = true">
		    			Jalanakan
		    		</button>
		    		<hr>
  		...
  		<div class="col-4">
  			<div class="card shadow mb-4">      					
		    	<div class="card-body text-center">
		    		...
		    		<hr/>
		    		<button class="btn btn-primary"
		    			onclick="window.location='<?php echo site_url();?>/admin/cronjob/action/expired-payment';this.disbaled = true">
		    			Jalanakan
		    		</button>
		    		<hr>
