    	...
    	<div class="card-body row">
	    	...
	    	<div class="col-md-3 col-lg-3 col-sm-12 mt-2">
	    		<select class="form-control"
	    			...
	    			onchange="this.form.submit() ">
	    				...
	    				<option value="blokir" <?php echo $this->input->get('status') == 'blokir' ? 'selected' : '';?>>Blokir</option>	    	
	    		</select>
	    	</div>
	    	...
	    	<div class="col-md-3 col-lg-3 col-sm-12 mt-2">
	    		<select class="form-control"
	    			...
	    			onchange="this.form.submit()">
	    				<option value=''>Pilih</option>	    			
	    				<option value="male" <?php echo $this->input->get('gender') == 'male' ? 'selected' : '';?>>Laki-Laki</option>
	    				<option value="female" <?php echo $this->input->get('gender') == 'female' ? 'selected' : '';?>>Perempuan</option>	    
	    		</select>
	    	</div>
	    	...
	    	<div class="col-md-3 col-lg-3 col-sm-12 mt-2">
	    		<a class="btn btn-info" 
	    			href="<?php echo site_url();?>/admin/user">
