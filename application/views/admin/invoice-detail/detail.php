<div class="col-12">
	<div class="card shadow mb-4">      					
		<div class="card-body">
				<h5>Detail Invoice #<?php echo $invoice['id'];?> - <?php echo $user['first_name'];?></h5>
			...
			<div class="table-responsive">
				<table class="table table-borderless table-hover">
					...
					<tr>
						<td>Dibuat</td>
						<td><?php echo $invoice['get_human_created_at'];?></td>
					</tr>
					<tr>
						<td colspan="2" class="text-center">
							<?php if($invoice['status'] == 'pending'){ ?>
								<button class="btn btn-success mt-2"
									onclick="window.location='<?php echo site_url();?>/admin/invoice/action/payment/<?php echo $invoice['id'];?>';this.disabled = true">
							...
							<?php }elseif($invoice['status'] == 'prepare'){ ?>
								<button class="btn btn-success mt-2"
									onclick="window.location='<?php echo site_url();?>/admin/invoice/action/withdrawing-stuff/<?php echo $invoice['id'];?>';this.disabled = true">
							...
							<?php }elseif($invoice['status'] == "withdrawing stuff"){ ?>
								<button class="btn btn-success mt-2"
									onclick="window.location='<?php echo site_url();?>/admin/invoice/action/in-rent/<?php echo $invoice['id'];?>';this.disabled = true">
							...
							<?php }elseif($invoice['status'] == "in rent"){ ?>
								<button class="btn btn-success mt-2"
									onclick="window.location='<?php echo site_url();?>/admin/invoice/action/backing-stuff/<?php echo $invoice['id'];?>';this.disabled = true">
							...
							<?php }elseif($invoice['status'] == 'backing stuff'){ ?>
								<button class="btn btn-success mt-2"
									onclick="window.location='<?php echo site_url();?>/admin/invoice/action/completed/<?php echo $invoice['id'];?>';this.disabled = true">
