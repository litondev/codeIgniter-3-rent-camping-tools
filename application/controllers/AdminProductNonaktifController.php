...
class AdminProductNonaktifController extends CI_Controller{
	...
	public function index(){
        $searchView = $this->load->view("admin/product-nonaktif/search",[],TRUE);

        $this->LTemplate->headerAdmin();

        $this->load->view("admin/product-nonaktif",[
            "search" => $searchView,            
    ...
    public function searchPagi($pageQuery){  
        ...
        $pageQuery = $pageQuery->where('status','nonaktif');
