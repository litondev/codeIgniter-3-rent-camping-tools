...
class AdminReviewPositifController extends CI_Controller{
	...
	public function index(){
        $searchView = $this->load->view("admin/review-positif/search",[],TRUE);
        ...
        $this->load->view("admin/review-positif",[
            "search" => $searchView,
    ...
    public function searchPagi($pageQuery){  
        ...
        $pageQuery = $pageQuery->where($this->MReview->table.".star >=",3);
